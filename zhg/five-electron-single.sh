...
//the new one
    ...
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n]/f1;
      }
      }else
      {
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n];
      }
      }
    ...
    if(newevenposition%2 == 0)
     {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
     } 
     }else
     {
    if(newevenposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n]/f1;
      }
...
#include <stdio.h>
   ...
   double  finalall[50];
   double  finalsingleall[50];
   double  finalall1;
   double  finalsingleall1;
  ...
  finaltree->Branch("finalsingleall",&finalsingleall,"finalsingleall[50]/D");
  ...
  for (long i=0; i< encal; ++i)
 {
   ...
   for(int m=0;m <10; m++)
   {
    ...
    finalsinglall1  = finalsingleall1 + fivesinglecal[l][m][n];
   }
    ...
    finalsingleall[n]= finalsingleall1;
   }
