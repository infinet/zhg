...
1.005564,1.114255,0.902073,0.868974,0.95253,1.041639,1.982235,1.244247,0.992191,1.865165
    ...
    int oddposition=$odd;
    int evenposition=$even;
    int beamoddposition=$beamodd;
    int beamevenposition=$beameven;
  ...
  for (long i=0; i< encal; ++i)
 {
    ...
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factorincrease[oddposition]/factorincrease[beamoddposition]*factorincrease[beamoddposition]/factorincrease[newoddposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factordecrease[oddposition]/factordecrease[beamoddposition]*factorincrease[beamoddposition]/factorincrease[newoddposition])*truncatedsinglecal[l][m][n]/f1;
      }
      }else
      {
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factorincrease[oddposition]/factorincrease[beamoddposition]*factordecrease[beamoddposition]/factordecrease[newoddposition])*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factordecrease[oddposition]/factordecrease[beamoddposition]*factordecrease[beamoddposition]/factordecrease[newoddposition])*truncatedsinglecal[l][m][n];
      }
      }
    ...
    if(newevenposition%2 == 0)
     {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factordecrease[evenposition]/factordecrease[beamevenposition]*factordecrease[beamevenposition]/factordecrease[newevenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factorincrease[evenposition]/factorincrease[beamevenposition]*factordecrease[beamevenposition]/factordecrease[newevenposition])*truncatedsinglecal[l][m][n];
     } 
     }else
     {
    if(newevenposition%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factordecrease[evenposition]/factordecrease[beamevenposition]*factorincrease[beamevenposition]/factorincrease[newevenposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*factorzhangmodified[l][m][n]*(factorincrease[evenposition]/factorincrease[beamevenposition]*factorincrease[beamevenposition]/factorincrease[newevenposition])*truncatedsinglecal[l][m][n]/f1;
      }
