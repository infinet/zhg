...
//     scaledcal[l][m][n] = factorhan[l][m][n]*truncatedsinglecal[l][m][n] ;
     scaledcal[l][m][n] = factorzhang[l][m][n]*truncatedsinglecal[l][m][n] ;
   }
   }
   }
...
/*
    ...
    for(int m=0;m <10; m++)
   {
    ...
    if(n%2 == 0)
    {
      scaledcal[l][m][n] = (factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n] ;
    }else
    {
      scaledcal[l][m][n] = (factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n];
    }
   ...
   for(int n=0; n <50; n++)
   {
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = (factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = (factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
    }
