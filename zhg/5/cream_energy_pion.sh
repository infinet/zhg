...
//  if(sumcal[0][0][oddposition] +sumcal[1][0][evenposition]+sumcal[0][1][oddposition]+sumcal[1][1][evenposition]>energycut)
//if(sumsinglecal[0][0][oddposition] +sumsinglecal[1][0][evenposition]+sumsinglecal[0][1][oddposition]>energycut)
{
...
double factordecrease[50]=  {1.11879,1.11309,1.10743,1.10179,1.09619,1.09061,1.08506,1.07954,1.07404,1.06858,1.06314,1.05773,1.05234,1.04699,1.04166,1.03636,1.03109,1.02584,1.02062,1.01542,1.01026,1.00512,1,0.994911,0.989848,0.984811,0.979799,0.974813,0.969852,0.964916,0.960006,0.95512,0.95026,0.945424,0.940612,0.935826,0.931063,0.926325,0.921611,0.916921,0.912254,0.907612,0.902993,0.898398,0.893826,0.889277,0.884751,0.880249,0.875769,0.871312};
...
for(int l=0;l <2; l++)
  ...
  for(int n=0; n <50; n++)
   {
//     scaledcal[l][m][n] = factorhanmodified[l][m][n]*truncatedsinglecal[l][m][n] ;
...
*/
    ...
    if(n%2 == 0)
    {
      scaledcal[l][m][n] = 0.95*corrector[l][m]*(factorzhangmodified[l][m][n]/factorincrease[oddposition])*truncatedsinglecal[l][m][n]/f1;
    }else
    {
      scaledcal[l][m][n] = 0.95*corrector[l][m]*(factorzhangmodified[l][m][n]/factordecrease[oddposition])*truncatedsinglecal[l][m][n];
    }
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = 0.95*corrector[l][m]*(factorzhangmodified[l][m][n]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = 0.95*corrector[l][m]*(factorzhangmodified[l][m][n]/factorincrease[evenposition])*truncatedsinglecal[l][m][n]/f1;
    }
    }
    }
    }
...
/*
    ...
    if(n%2 == 0)
    {
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n]/f1;
      }
      }else
      {
    if(newoddposition%2 == 0)
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n];
      }
      }
    ...
    if(n%2 == 0)
     {
    if(newevenposition%2 == 0)
     {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
     } 
     }else
     {
    if(newevenposition%2 == 0)
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n]/f1;
      }else
      {
      scaledcal[l][m][n] = s*(factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n]/f1;
      }
