...
double factordecrease[50]={1.13396,1.1275,1.12107,1.11468,1.10833,1.10202,1.09574,1.08949,1.08329,1.07711,1.07098,1.06487,1.05881,1.05277,1.04678,1.04081,1.03488,1.02898,1.02312,1.01729,1.01149,1.00573,1,0.994302,0.988636,0.983003,0.977402,0.971833,0.966295,0.960789,0.955315,0.949871,0.944459,0.939078,0.933727,0.928406,0.923116,0.917856,0.912627,0.907426,0.902256,0.897115,0.892003,0.88692,0.881867,0.876842,0.871846,0.866878,0.861938,0.857027};

double factorincrease[50]={0.8818665,0.8869199,0.8920031,0.897115,0.9022558,0.9074265,0.9126259,0.9178563,0.9231164,0.9284064,0.9337263,0.939078,0.9444586,0.949871,0.9553143,0.9607896,0.9662957,0.9718326,0.9774015,0.9830033,0.9886359,0.9943015,1,1.0057304,1.0114937,1.01729,1.0231202,1.0289834,1.0348794,1.0408064,1.0467745,1.0527735,1.0588033,1.0648743,1.0709762,1.0771192,1.0832828,1.0894979,1.0957335,1.1020206,1.1083283,1.1146874,1.1210671,1.1274982,1.1339603,1.1404531,1.1469872,1.1535624,1.1601788,1.166826};
...
// without attenuation correction
    ...
    for(int m=0;m <10; m++)
   {
    ...
    if(n%2 == 0)
    {
      scaledcal[l][m][n] = 0.95*(factorzhangmodified[l][m][n]*factorincrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n] ;
    }else
    {
      scaledcal[l][m][n] = 0.95*(factorzhangmodified[l][m][n]*factordecrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n];
    }
   ...
   for(int n=0; n <50; n++)
   {
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = 0.95*(factorzhangmodified[l][m][n]*factordecrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = 0.95*(factorzhangmodified[l][m][n]*factorincrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
    }
