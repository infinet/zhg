...
//the new one
    ...
    for(int m=0;m <10; m++)
   {
    ...
    if(n%2 == 0)
    {
      scaledcal[l][m][n] = (factor1[l][m][n]*factordecrease[newoddposition]/factordecrease[oddposition])*truncatedsinglecal[l][m][n] ;
    }else
    {
      scaledcal[l][m][n] = (factor1[l][m][n]*factorincrease[newoddposition]/factorincrease[oddposition])*truncatedsinglecal[l][m][n];
    }
   ...
   for(int n=0; n <50; n++)
   {
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = (factor1[l][m][n]*factorincrease[newevenposition]/factorincrease[evenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = (factor1[l][m][n]*factordecrease[newevenposition]/factordecrease[evenposition])*truncatedsinglecal[l][m][n];
    }
