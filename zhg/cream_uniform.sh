...
*/
    ...
    for(int n=0; n <50; n++)
    {
      if(n%2 == 0)
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[oddposition]/factorincrease[newoddposition])*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[oddposition]/factordecrease[newoddposition])*truncatedsinglecal[l][m][n];
      }
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factordecrease[evenposition]/factordecrease[newevenposition])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*corrector[l][m]*(factorzhangmodified[l][m][n]*factorincrease[evenposition]/factorincrease[newevenposition])*truncatedsinglecal[l][m][n];
      }
