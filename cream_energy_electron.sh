...
//if(sumcal[0][0][oddposition] > energycut && sumcal[0][1][oddposition]>energycut &&sumlecal[0][0][evenposition] > energycut && sumcal[1][1][evenposition]> energycut)
...
/*
    ...
    for(int n=0; n <50; n++)
    {
      if(n%2 == 0)
      {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*horizoncorrector[n]*factorzhangmodified[l][m][n]*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*horizoncorrector[n]*factorzhangmodified[l][m][n]*truncatedsinglecal[l][m][n];
      }
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*verticalcorrector[n]*factorzhangmodified[l][m][n]*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*verticalcorrector[n]*factorzhangmodified[l][m][n]*truncatedsinglecal[l][m][n];
      }
...
*/
    ...
    for(int n=0; n <50; n++)
    {
      if(n%2 == 0)
      {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*horizoncorrector[n]*(factorzhangmodified[l][m][n]*signalincrease[$even]/signalincrease[$neweven])*truncatedsinglecal[l][m][n];
      }else
      {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*horizoncorrector[n]*(factorzhangmodified[l][m][n]*signaldecrease[$even]/signaldecrease[$neweven])*truncatedsinglecal[l][m][n];
      }
    ...
    if(n%2 == 0)
     {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*verticalcorrector[n]*(factorzhangmodified[l][m][n]*signaldecrease[$odd]/signaldecrease[$newodd])*truncatedsinglecal[l][m][n];
     }else
     {
      scaledcal[l][m][n] = s*total[n]*corrector[l][m]*verticalcorrector[n]*(factorzhangmodified[l][m][n]*signalincrease[$odd]/signalincrease[$newodd])*truncatedsinglecal[l][m][n];
      }
