...
//if(sumcal[0][0][oddposition]> energycut&&sumcal[0][1][oddposition]> energycut&&sumcal[1][0][evenposition]> energycut&&sumcal[1][1][evenposition]>energycut&&sumcal[0][8][oddposition]> energycut&&sumcal[0][9][oddposition]> energycut&&sumcal[1][8][evenposition]> energycut&& sumcal[1][9][evenposition] > energycut)


//if(sumsinglecal[0][0][oddposition]> energycut&&sumsinglecal[0][1][oddposition]> energycut&&sumsinglecal[1][0][evenposition]> energycut&&sumsinglecal[1][1][evenposition]>energycut&&sumsinglecal[0][8][oddposition]> energycut&&sumsinglecal[0][9][oddposition]> energycut&&sumsinglecal[1][8][evenposition]> energycut&& sumsinglecal[1][9][evenposition] > energycut)

if(sumsinglecal[0][0][oddposition]> energycut&&sumsinglecal[0][1][oddposition]> energycut&&sumsinglecal[1][0][evenposition]> energycut&&sumsinglecal[1][1][evenposition]>energycut&&sumsinglecal[0][8][oddposition]> energycut&&sumsinglecal[0][9][oddposition]> energycut&&sumsinglecal[1][8][evenposition]> energycut&& sumsinglecal[1][9][evenposition] > energycut&&sumcal[0][0][oddposition]> energycutsum&&sumcal[0][1][oddposition]> energycutsum&&sumcal[1][0][evenposition]> energycutsum&&sumcal[1][1][evenposition]>energycutsum&&sumcal[0][8][oddposition]> energycutsum&&sumcal[0][9][oddposition]> energycutsum&&sumcal[1][8][evenposition]> energycutsum&& sumcal[1][9][evenposition] > energycutsum)
{
...
{0.098603208,   0.143194238,    0.286659623,    0.128669592,    0.354060236,    0.077813405,    0.080016702,    0.114220705,    0.080130751,    0.082878943,    0.079604782,    0.079359894,    0.101168968,    0.099840189,    0.083869511,    0.097507415,    0.073033089,    0.086899503,    0.090981264,    0.097135949,    0.089766997,    0.096354513,    0.081962522,    0.11652531,     0.090240193,    0.114490142,    0.090025707,    0.107128137,    0.071913773,    0.088270916,    0.083338626,    0.089400405,    0.078564596,    0.11758444,     0.09108577,     0.093659441,    0.084097206,    0.083497271,    0.082692607,    0.085042493,    0.071522575,    0.079195652,    0.091749771,    0.092615841,    0.094172294,    0.117726043,    0.215416046,    0.182005389,    0.082736526,    0.434886443},
